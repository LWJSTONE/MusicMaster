-- =====================================
-- MusicMaster 音乐管理系统 H2数据库表结构
-- 兼容MySQL模式
-- =====================================

-- 用户表 (USER是H2保留字，需要特殊处理)
...
CREATE TABLE IF NOT EXISTS song (
  ...
  uploader_id bigint(20) DEFAULT NULL COMMENT '上传者用户ID',
  uploader_name varchar(50) DEFAULT NULL COMMENT '上传者用户名',
  create_time timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  update_time timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  deleted tinyint(4) DEFAULT '0' COMMENT '删除标记：0-未删除，1-已删除',
  PRIMARY KEY (id)
